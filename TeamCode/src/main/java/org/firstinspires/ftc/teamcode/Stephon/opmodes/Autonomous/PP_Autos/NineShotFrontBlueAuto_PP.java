...
@Autonomous(name = "🔵 9 Shot FRONT", group = "(1) PP Autonomous (Blue)")
public class NineShotFrontBlueAuto_PP extends OpMode {
    ...
    private static final double SHOOTING_ANGLE_2 = 132;
    ...
    private final Pose INTAKE_CONTROL_1 = new Pose(56, 82);
    private final Pose INTAKE_POS_1 = new Pose(16, 83);

    // Second row positions
    private final Pose APPROACH_2 = new Pose(55, 60);
    private final Pose INTAKE_POS_2 = new Pose(9, 60);
    ...
    public void init() {
        ...
        path3 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(SHOOTING_ANGLE_2))
                .build();

        // Path 4: Scoring to approach row 2
        path4 = follower.pathBuilder()
                .addPath(new BezierLine(SCORING_POS, APPROACH_2))
                .setLinearHeadingInterpolation(Math.toRadians(SHOOTING_ANGLE_2), Math.toRadians(180))
                .build();
        ...
        telemetry.addLine("Ready - 9 Shot Front Blue");
        telemetry.update();
    }
