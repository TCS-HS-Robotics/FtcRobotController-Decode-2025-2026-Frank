...
@Autonomous(name="Back Stephon Auto Blue", group="1")
public class BackStephonAutoBlue extends LinearOpMode {
    ...
    int DRIVE_OUT_TIME = 1200;          // 2 seconds to drive out of launch zone
