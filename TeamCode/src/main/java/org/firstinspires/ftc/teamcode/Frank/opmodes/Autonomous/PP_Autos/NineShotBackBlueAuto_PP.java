...
@Autonomous(name = "\uD83D\uDD35 9 Shot BACK", group = "(1) PP Autonomous (Blue)")
public class NineShotBackBlueAuto_PP extends OpMode {
    ...
    private static final double SHOOTING_ANGLE = 111;

    // Positions
    private final Pose START_POSE = new Pose(56.957, 8.554, Math.toRadians(90));
    private final Pose SCORING_POS = new Pose(56.957, 14.949);

    // Row 1 (first pickup)
    private final Pose APPROACH_1 = new Pose(54, 36);
    private final Pose ARTIFACT_1 = new Pose(9, 36);

    // Row 2 (second pickup)
    private final Pose APPROACH_2 = new Pose(57, 60);
    private final Pose ARTIFACT_2 = new Pose(9, 60);
    ...
    public void init() {
        ...
        path2 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(SHOOTING_ANGLE), Math.toRadians(180))
                .build();
        ...
        telemetry.addLine("Ready - 9 Shot Back Blue");
        telemetry.update();
    }
