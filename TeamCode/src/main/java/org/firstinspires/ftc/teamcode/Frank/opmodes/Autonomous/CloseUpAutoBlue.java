...
@Autonomous(name="Close Up Auto Blue", group="2")
public class CloseUpAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Close Up Auto - BLUE Alliance");
        ...
        // --- STATE 5: Strafe RIGHT (blue team) ---
        robot.drivetrain._strafeRight(STRAFE_SPEED);
        runtime.reset();
        while (opModeIsActive() && (runtime.milliseconds() < STRAFE_TIME)) {
            telemetry.addLine("STATE 5: Strafing RIGHT...");
