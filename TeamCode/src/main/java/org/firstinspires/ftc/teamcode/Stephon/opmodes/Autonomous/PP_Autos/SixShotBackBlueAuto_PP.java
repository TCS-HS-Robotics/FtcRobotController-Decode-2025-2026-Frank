...
@Autonomous(name = "🔵 6 Shot BACK", group = "(1) PP Autonomous (Blue)")
public class SixShotBackBlueAuto_PP extends OpMode {
    ...
    private final Pose PARK_POS = new Pose(9, 11);  // Final parking position
